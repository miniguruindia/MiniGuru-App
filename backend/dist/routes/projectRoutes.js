...
projectRouter.post('/', authMiddleware_1.authenticateToken, resolveSubject_1.resolveSubject, projectController_1.createProject);
...
projectRouter.post('/:id/comment', authMiddleware_1.authenticateToken, (0, validationMiddleware_1.idValidationRules)(), validateRequest_1.validateRequest, commentController_1.addProjectComment);
projectRouter.post('/:id/like', authMiddleware_1.authenticateToken, (0, validationMiddleware_1.idValidationRules)(), validateRequest_1.validateRequest, likeController_1.likeProject);
