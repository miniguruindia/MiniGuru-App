...
async function sendRegistrationVerificationOtp(userId, destination) {
    try {
        ...
        logger_1.default.warn(`Registration verification email failed (non-blocking): ${err?.message || err}`);
    }
}
