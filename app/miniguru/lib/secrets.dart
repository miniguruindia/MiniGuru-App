...
const String youtubeChannelId = 'UCfk6tZ_HJ4412cxrNMXlSIA'; // Your channel ID
const String youtubeChannelHandle = '@MiniGuru.innovation';

// Other configuration
const String appVersion = '1.0.0';
const String appName = 'MiniGuru';
