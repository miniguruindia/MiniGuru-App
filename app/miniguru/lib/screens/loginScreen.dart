...
class _LoginScreenState extends State<LoginScreen> {
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(12),
                      borderSide:
                          const BorderSide(color: pastelBlueText, width: 2),
                    ),
                  ),
                  validator: (value) {
                      ...
                      if (resetFormKey.currentState!.validate()) {
                        ...
                        try {
                          ...
                          if (dialogContext.mounted)
                            Navigator.of(dialogContext).pop();
                          _showSnackBar(
                              'Error sending reset request.', Colors.red);
                        }
                      }
                    },
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      IconButton(
                        icon:
                            const Icon(Icons.copy, color: pastelBlueText),
                        onPressed: () {
                          Clipboard.setData(
                              ClipboardData(text: tempPassword));
                          _showSnackBar(
                              'Password copied! 📋', Colors.green);
                        },
                      ),
                    ],
                  ),
        ...
        actions: [
          ElevatedButton.icon(
            onPressed: () {
              ...
              _showSnackBar(
                  'Login details filled! Click Login to continue.',
                  Colors.blue);
            },
  ...
  void _showSnackBar(String msg, Color color) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content:
            Text(msg, style: bodyTextStyle.copyWith(color: Colors.white)),
